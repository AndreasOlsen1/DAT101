...
export class TObstacle{
  ...
  setDayNight(aIsDayMode){
    //vi ønsker å sette dag og nattmode på hindrene i spillet.
    //om vi vil finne ut av hvor mange indexer det er av hver tegnet
    //kategori kan vi finne det i SpriteInfoList. det er 4 av obstacle. 
    //antar derfor at #spDown har to index bilder og det samme med this.#spUp.
  if(aIsDayMode){
    this.#spDown.index = 2;
    this.#spUp.index = 3;
  }
  ...
  //dette må derfor bli 0 og 1, da 0,1,2,3 er fire bilder. 
}
